...
let addRegistrationForm = document.getElementById('add-registration_detail-form-ajax');
...
addRegistrationForm.addEventListener("submit", function (e) {
    ...
    xhttp.open("POST", "/add-registration_detail-ajax", true);
...
addRowToTable = (data) => {
    ...
    let currentTable = document.getElementById("registration_details-table");
    ...
    let cellData = [
        newRow.registration_details_id,
