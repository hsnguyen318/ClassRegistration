...
addRowToTable = (data) => {
    ...
    // Find drop-down menu, create a new option, fill data in the option (details about the class)
    ...
    option.text = newRow.class_id + ' ' + newRow.class_code + ' ' + newRow.year + ' ' + newRow.quarter;
