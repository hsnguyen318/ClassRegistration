...
let addSectionForm = document.getElementById('add-section-form-ajax');
...
addSectionForm.addEventListener("submit", function (e) {
    ...
    xhttp.open("POST", "/add-section-ajax", true);
...
addRowToTable = (data) => {
    ...
    let currentTable = document.getElementById("sections-table");
    ...
    row.setAttribute('data-value', newRow.section);
